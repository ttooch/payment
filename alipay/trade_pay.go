...
func (tra *AliTrade) Handle(conf map[string]interface{}, privateKey string, aliPublicKey string) (string, error) {
...
func (tra *AliTrade) RetData(ret []byte, aliPublicKey string) (re string, err error) {
